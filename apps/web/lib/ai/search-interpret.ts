...
export function buildSearchInterpretPrompt(queryText: string, vertical?: string | null): string {
  return [
    ...
    '  "countries": string[],       // full country names, e.g. "Singapore", "United States" — ONLY specific',
    '                                // countries the request actually implies. At most 5. Never list every',
    '                                // country in a region as a substitute for saying the region.',
    '  "regions": string[],         // broader areas, e.g. "Southeast Asia", "MENA" — prefer this over a long',
    '                                // countries list whenever the request means "anywhere in this area"',
